    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('atualizado_em', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='sub_soft_skills_atualizadas', to=settings.AUTH_USER_MODEL)),
